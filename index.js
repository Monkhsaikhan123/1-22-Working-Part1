...
app.post('/saveProduct', async(req,res)=>{
    const {name, image, desc, price, imageURL, category} = req.body;
   try {
        Products.create({name:name, desc:desc, price:price, category:category,image:image ,imageURL:imageURL})
        res.send({success:true, message: "data delete success", data:data})
   } catch (error) {
        res.send({status:"error", data:error})
   }
...
app.put('/updateProduct/:id', async(req,res)=>{
    ...
    await Products.updateOne({_id:req.body._id},{name: "updated"})
    res.send({success:true, message: "data update success",})
})
